...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, Order> producerFactoryJson() throws UnknownHostException {
    ...
    @Bean
    public KafkaTemplate<String, Order> kafkaTemplateJson() throws UnknownHostException {
